    ...
    <?php 
     ...
     ini_set('display_errors', 1);
        ...
        foreach ($pro_bd as $pro_mostrar) {
            ...
            echo "Cod_Livro: " . $pro_mostrar[1] . "&nbsp;&nbsp;&nbsp;&nbsp;";//como matriz - posição 1
            echo "DataLancamento: " . $pro_mostrar[2] . "&nbsp;&nbsp;&nbsp;&nbsp;";//como matriz - posição 2
            echo "Editora: " . $pro_mostrar[3] . "&nbsp;&nbsp;&nbsp;&nbsp;";//como matriz - posição 3
