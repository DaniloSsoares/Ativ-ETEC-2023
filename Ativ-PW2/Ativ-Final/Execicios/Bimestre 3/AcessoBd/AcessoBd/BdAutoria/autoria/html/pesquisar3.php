...
<header>
    ...
    <div class="logreg-box">
        <div class="caixa-Login">
            <form action="" name="cliente" method="POST">
                ...
                <Label>Pesquisar:(Cod_Livro)</Label>
                </div>
    ...
    <?php 
     ...
     ini_set('display_errors', 1);
        ...
        $p = new Autoria3();
        $p->setCod_Livro($_POST['txtnome'] . '%');// Concatenando '%' para busca aproximada
        $pro_bd = $p->consultar(); // Chamada do método com retorno
        foreach ($pro_bd as $pro_mostrar) {
            echo "<tr>";
            echo "<td>Cod_Livro: " . $pro_mostrar[0] . "</td>";//como matriz - posição 0
            echo "<td>Tiíulo: " . $pro_mostrar[1] . "</td>";//como matriz - posição 1
            echo "<td>Categoria: " . $pro_mostrar[2] . "</td>";//como matriz - posição 2
            echo "<td>ISBN: " . $pro_mostrar[3] . "</td>";//como matriz - posição 3
            echo "<td>Idioma: " . $pro_mostrar[4] . "</td>";//como matriz - posição 4
            echo "<td>Qtdepag: " . $pro_mostrar[5] . "v";//como matriz - posição 5
        }
