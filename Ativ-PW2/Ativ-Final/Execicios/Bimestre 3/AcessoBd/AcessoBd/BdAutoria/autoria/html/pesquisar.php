...
<header>
    ...
    if(isset($_POST['btnpesquisar'])){
        ...
        foreach ($pro_bd as $pro_mostrar) {
            ...
            echo "<td>NomeAutor: " . $pro_mostrar[1] . "</td>"; //como matriz - posição 1
            echo "<td>Sobrenome: " . $pro_mostrar[2] . "</td>";//como matriz - posição 2
            echo "<td>Email: " . $pro_mostrar[3] . "</td>";//como matriz - posição 3
            echo "<td>Nasc: " . $pro_mostrar[4] . "</td>";//como matriz - posição 4
            echo "</tr>";
