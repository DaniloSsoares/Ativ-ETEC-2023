...
<div class="logreg-box">
            <div class="caixa-Login">
                <form name ="cliente" action="" method="POST">
                    ...
                    <input id="id" name="txtid2" type="text" >
                    <label>Id Do autoria:</label>
                </div>

               
        
                   
                   <input type="submit" name="btn_excluir_autoria2" value="Excluir Autoria2" class="btn">
       ...
       if(isset($btn_excluir_autoria2) && !empty($txtid2))
       {
