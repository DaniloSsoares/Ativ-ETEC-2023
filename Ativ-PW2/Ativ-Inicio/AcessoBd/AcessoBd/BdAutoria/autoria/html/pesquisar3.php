    ...
    <?php 
     ...
     ini_set('display_errors', 1);
        ...
        foreach ($pro_bd as $pro_mostrar) {
            echo "Cod_Livro: " . $pro_mostrar[0] . "&nbsp;&nbsp;&nbsp;&nbsp;";//como matriz - posição 0
            echo "Tiíulo: " . $pro_mostrar[1] . "&nbsp;&nbsp;&nbsp;&nbsp;";//como matriz - posição 1
            echo "Categoria: " . $pro_mostrar[2] . "&nbsp;&nbsp;&nbsp;&nbsp;";//como matriz - posição 2
            echo "ISBN: " . $pro_mostrar[3] . "&nbsp;&nbsp;&nbsp;&nbsp;";//como matriz - posição 3
            echo "Idioma: " . $pro_mostrar[4] . "&nbsp;&nbsp;&nbsp;&nbsp;";//como matriz - posição 4
            echo "Qtdepag: " . $pro_mostrar[5] . "&nbsp;&nbsp;&nbsp;&nbsp;";//como matriz - posição 5
        }
