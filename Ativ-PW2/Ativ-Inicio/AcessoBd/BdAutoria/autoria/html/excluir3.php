...
<div class="logreg-box">
            <div class="caixa-Login">
                ...
                <div class="input-box">
                    ...
                    <input id="id" name="txtid3" type="text"  >
                    <label>Id do Livro:</label>
                </div>
                  
        
                   <input type="submit" name="btn_excluir_autoria3" value="Excluir Autoria3" class="btn">
       ...
       if(isset($btn_excluir_autoria3)&& !empty($txtid3))
       {
           include_once 'autoria.php';
           $p = new Autoria3();
           $p->setCod_Livro($txtid3);
