...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24-Abr-2023 às 19:28
...
INSERT INTO `alunos` (`matricula`, `nome`, `endereço`, `cidade`, `codcurso`) VALUES
...
(10008, ' Caique dos Santos', 'Rua das Amoreiras, 555 ', 'Campinas', 2),
...
(10012, ' Richardson S. P. Campeao ', 'Rua do Tricolor, 433', 'São Paulo', 3),
(10013, 'Junior Camisa Seis', '  Rua do Morumbi, 433', 'SãoPaulo ', 3),
...
--
-- Estrutura da tabela `discilinas`
--

CREATE TABLE `discilinas` (
  `CodDisciplina` int(2) NOT NULL,
  `NomeDiciplina` varchar(30) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;

--
-- Extraindo dados da tabela `discilinas`
--

INSERT INTO `discilinas` (`CodDisciplina`, `NomeDiciplina`) VALUES
(11, 'Banco de Dados'),
...
--
-- Índices para tabela `discilinas`
--
ALTER TABLE `discilinas`
...
--
-- AUTO_INCREMENT de tabela `discilinas`
--
ALTER TABLE `discilinas`
  MODIFY `CodDisciplina` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
COMMIT;
