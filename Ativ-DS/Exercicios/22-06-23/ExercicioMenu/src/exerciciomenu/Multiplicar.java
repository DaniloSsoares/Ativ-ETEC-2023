...
public class Multiplicar {
    public static class Inicial extends JDialog {
        ...
        public Inicial(Frame owner, String title, boolean modal) {
            ...
            exibir = new JLabel("");
            multiplicar2n= new JButton("Multiplicar");
            ...
            multiplicar2n.setBounds(150, 100, 120, 20);
            limpar.setBounds(260,250,100,20);

            multiplicar2n.addActionListener(new ActionListener() {
          ...
          Color foregroundColor = Color.RED;
            ...
            multiplicar2n.setBackground(Color.BLACK);
            multiplicar2n.setForeground(Color.RED);
