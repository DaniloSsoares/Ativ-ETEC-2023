...
public class Dividir {
     public static class Inicial extends JDialog {
        ...
        public Inicial(Frame owner, String title, boolean modal) {
            ...
            dividir2n.setBounds(150, 100, 80, 20);
            limpar.setBounds(260,250,100,20);

             dividir2n.addActionListener(new ActionListener() {
            ...
            dividir2n.setBackground(Color.BLACK);
            dividir2n.setForeground(Color.RED);
